...
const connectionOptions = {
  ...
  browser: ['Mickey-Bot','FireFox','1.0.0']
}
...
global.reloadHandler = async function (restatConn) {
  ...
  conn.welcome = '🥳 Bienvenid@ @user\n\n_Puedes solicitar mi lista de comandos con #menu_'
  conn.bye = '👋🏻 Bye @user'
  conn.spromote = '@user Ahora eres admin del grupo'
  conn.sdemote = '@user Dejaste de ser admin'
  conn.sDesc = 'La descripción del grupo fue cambiada por @user, La nueva descripción es\n@desc'
  conn.sSubject = 'El nombre del grupo fue cambiado por @user, El nuevo nombre es\n@subject'
  conn.sIcon = 'La foto del grupo fue cambiada con éxito por @user'
  conn.sRevoke = 'Nuevo link \n@revoke'
...
_quickTest()
  .then(() => conn.logger.info('CARGANDO PLUGINS...'))
  .catch(console.error)
